...
Future<RegisterUsers> performRegister(
    String name,
    String faculty,
    int registrationNo,
    int batch,
  ...
  Response response;
  Dio dio = new Dio();
  var url = 'http://192.168.1.74:8000/register/';
...
// print(formData.toString());
  ...
  if (response.statusCode == 200) {
    ...
    var newurl = 'http://192.168.1.74:8000/upload_photo/';
    ...
    try {
      final responsePhoto = await dio.patch(
        photourl,
        data: formData,
      );
...
class _Register2State extends State<Register2> {
  ...
  Widget build(BuildContext context) {
    final userDetails =
        ModalRoute.of(context).settings.arguments as RegisterClass;
    return MaterialApp(
